...
export default function IntakeFlowGraphic() {
  ...
  return (
    <div ref={ref} className="onboarding-grid" style={{ display: 'grid', gridTemplateColumns: '380px 1fr', gap: 0, alignItems: 'stretch', minHeight: 520, position: 'relative' }}>
      {/* Form */}

...
export default function LeadAdvisor() {
  return (
    <section style={{ padding: '112px 32px', background: 'var(--cream-50)' }}>
      <div style={{ maxWidth: 'var(--maxw-page)', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
        ...
        <Reveal delay={150} style={{ display: 'flex', justifyContent: 'center' }}>
          <div style={{ position: 'relative' }}>
            <div style={{ width: 340, height: 400, borderRadius: 'var(--radius-2xl)', overflow: 'hidden', boxShadow: 'var(--shadow-lg)', position: 'relative' }}>
              <Image
                src="/advisor.png"
            ...
            {/* Card */}
            <div style={{ position: 'absolute', bottom: -20, left: -20, background: '#fff', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)', padding: '16px 20px', boxShadow: 'var(--shadow-md)', minWidth: 200 }}>

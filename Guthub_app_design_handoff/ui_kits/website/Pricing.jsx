// Pricing.jsx — homepage pricing section (condensed)
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
        ...
        <Reveal delay={150} y={24}>
          ...
          <div style={{ fontSize: 14, color: 'var(--ink-500)', marginBottom: 28 }}>
            Month-to-month · Billed after your 2-day trial
          </div>
        ...
        <div style={{ marginTop: 32 }}>
          <a href="pricing.html" style={{
            color: 'var(--terracotta-200)', fontSize: 15, fontWeight: 600,
            textDecoration: 'none', borderBottom: '1px solid rgba(238,185,154,.4)', paddingBottom: 2,
